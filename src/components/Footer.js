    ...
    <footer className="footer">
      ...
      <div>
        ...
        <ul className="footer__content">
          <li className="footer__content-option">Home</li>
          <li className="footer__content-option">Sobre Nosotros</li>
          <li className="footer__content-option">Digital Alpha Money</li>
        </ul>
      </div>
      <div>
